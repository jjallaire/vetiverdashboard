...
This tab is used to see model performance over time. In this context, _performance_ is the statistical properties of the model, specifically, accuracy and recall. 

The data is grouped by week, starting in January of 2023 until July of 2023.
...
## Column {.sidebar}
This table shows the new inspections that our model misclassified, in either direction.
